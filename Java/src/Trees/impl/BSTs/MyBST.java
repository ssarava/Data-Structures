...
/**
 * My implementation of a binary search tree that does not support duplicates. Some
 * flattening/unflattening methods need to be implemented
 */
public class MyBST<T extends Comparable<T>> implements MyTree<T>, Set<T> {

    public static void main(String[] args) {
        MyBST<Integer> tree = new MyBST<>();
        // tree.insert(50);
        Integer[] keys = new Integer[] {38, 68};
        tree.insert(keys);
    ...
    protected class Node {
        ...
        public boolean equals(Object other) {
            ...
            if (!(other instanceof MyBST.Node)) {
                return false;
            }
    ...
    /**
     * Flattens the tree into a LinkedList, in place, following an inorder traversal. incomplete
     */
    ...
    /**
     * Unflattens the LinkedList-like tree, in place, following an inorder traversal.
     */
    ...
    /**
     * Unflattens the LinkedList-like tree, in place, following an post-order traversal.
     */
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof MyBST)) {
            return false;
        }
        MyBST<T> temp = (MyBST<T>) other;
