...
import Trees.impl.BSTs.MyAVLTree;

public class MyAVLTests {
    
    // private boolean widespreadConstructor(Integer[] keys) {
    //     MyAVLTree<Integer> bst1 = new MyAVLTree<>();
    //     bst1.insert(keys);
    //     MyAVLTree<Integer> bst2 = new MyAVLTree<>(bst1);
    ...
    //     MyAVLTree<Integer> treap = new MyAVLTree<>();
    //     assertTrue(treap.size() == 0);
    //     assertTrue(treap.size() == new MyAVLTree<>().size());
    ...
    private boolean testWidespreadLLInsert(Integer[] keys) {
        return true;
    }

    @Test
    public void testLLInsert() {
        Integer[] keys = null, check = null;

        keys = new Integer[] {10, 5, 20, 3, 7, 2};
        check = new Integer[] {5, 3, 10, 2, 7, 20};
