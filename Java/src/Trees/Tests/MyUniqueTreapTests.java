...
import Trees.impl.BinarySearchTrees.MyUniqueTreap;

public class MyUniqueTreapTests {
    
    private boolean widespreadConstructor(Integer[] keys, Integer[] priorities) {
        MyUniqueTreap<Integer> treap1 = new MyUniqueTreap<>();
        treap1.insert(keys, priorities);
        MyUniqueTreap<Integer> treap2 = new MyUniqueTreap<>(treap1);
    ...
    private boolean widespreadEquals(Integer[] keys, Integer[] priorities) {
        MyUniqueTreap<Integer> treap1= new MyUniqueTreap<>(), treap2 = new MyUniqueTreap<>();
        treap1.insert(keys, priorities);
